...
public class tvWishFragment extends Fragment {
    ...
    private void fetchdata(int page, final int last) {
        ...
        Call<MovieResponse> call = apiService.getTvFav(ConstantKey.getID(), ConstantKey.MOVIEDB_API, ConstantKey.getSESSION(), page);
