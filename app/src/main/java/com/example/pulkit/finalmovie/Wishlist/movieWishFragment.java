...
public class movieWishFragment extends Fragment {
    ...
    private void fetchdata(int page, final int last) {
        ...
        Call<MovieResponse> call = apiService.getMovieFav(ConstantKey.getID(), ConstantKey.MOVIEDB_API, ConstantKey.getSESSION(), page);
